public class RotatingPanel extends Panel implements Clickable {
    private float degrees;
    private boolean rotating;

    public RotatingPanel(int _x, int _y, int _width, int _height, String imageName) {
        super(_x, _y, _width, _height, imageName);
        degrees = 1;
        rotating = false;
    }
